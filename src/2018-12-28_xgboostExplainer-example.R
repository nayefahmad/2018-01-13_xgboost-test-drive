...
#***************************************************
# XGBOOST EXPLAINER EXAMPLE
# 2018-12-28 

# reference: https://medium.com/applied-data-science/new-r-package-the-xgboost-explainer-51dd7d1aa211 
#***************************************************
...
set.seed(123)
full = fread(here("data", "HR_comma_sep.csv"),
             stringsAsFactors = T)
full = full[sample(.N)]
...
# 7) IMPACT AGAINST VARIABLE VALUE: ------------
